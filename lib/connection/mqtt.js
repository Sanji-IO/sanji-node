...
Connection.prototype.subscribe = function(topic, options) {
  ...
  var subscribe = Promise.promisify(
    this._mqtt.subscribe, {context: this._mqtt});
  options = objectAssign(this.messageOptions, options);
...
Connection.prototype.unsubscribe = function(topic) {
  ...
  var unsubscribe = Promise.promisify(
    this._mqtt.unsubscribe, {context: this._mqtt});
...
Connection.prototype.publish = function(topic, message, options) {
  ...
  var jsonMessage = JSON.stringify(message),
      publish = Promise.promisify(this._mqtt.publish, {context: this._mqtt});
  options = objectAssign(this.messageOptions, options);
